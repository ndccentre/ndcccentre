        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-12">
            ...
            <div>
                ...
                <div class="flex items-center gap-3 mt-4">
                    @if($youtube = \App\Models\SiteSetting::get('social_youtube'))
                    <a href="{{ $youtube }}" target="_blank" rel="noopener" class="w-9 h-9 bg-white/10 rounded-full flex items-center justify-center hover:bg-red-600 transition" aria-label="YouTube">
                    ...
                    <a href="{{ $facebook }}" target="_blank" rel="noopener" class="w-9 h-9 bg-white/10 rounded-full flex items-center justify-center hover:bg-blue-600 transition" aria-label="Facebook">
                    ...
                    <a href="{{ $instagram }}" target="_blank" rel="noopener" class="w-9 h-9 bg-white/10 rounded-full flex items-center justify-center hover:bg-pink-600 transition" aria-label="Instagram">
                    ...
                    @endif
                    @if($tiktok = \App\Models\SiteSetting::get('social_tiktok'))
                    <a href="{{ $tiktok }}" target="_blank" rel="noopener" class="w-9 h-9 bg-white/10 rounded-full flex items-center justify-center hover:bg-gray-700 transition" aria-label="TikTok">
                ...
                <ul class="space-y-3 text-sm text-white/70">
                    ...
                    @if($phone = \App\Models\SiteSetting::get('contact_phone'))
                        <li class="flex items-center gap-2">
                            ...
                            <a href="tel:{{ $phone }}" class="hover:text-gold transition">{{ $phone }}</a>
                        </li>
                    @endif
                    @if($email = \App\Models\SiteSetting::get('contact_email'))
                        <li class="flex items-center gap-2">
                            ...
                            <a href="mailto:{{ $email }}" class="hover:text-gold transition">{{ $email }}</a>
                        </li>
                    @endif
                </ul>
            </div>
